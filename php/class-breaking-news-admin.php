...
class Breaking_News_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __DIR__ ) . 'css/breaking-news-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __DIR__ ) . 'js/breaking-news-admin.js', array( 'jquery' ), $this->version, false );
